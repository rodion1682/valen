    ...
    (() => {
        ...
        function rangeInit() {
            ...
            if (rangeItems.length) rangeItems.forEach((rangeItem => {
                ...
                const allInputs = [ toValue, fromValue ];
                ...
                const setPriceSlider = (i, value) => {
                    ...
                    inputArray[i] = value;
                    item.noUiSlider.set(inputArray);
                };
        ...
        function initSliders() {
            ...
            if (document.querySelector(".gallery-slider__slider")) new core(".gallery-slider__slider", {
                ...
                loop: true,
                navigation: {
                    prevEl: ".gallery-slider__arrow_left",
                    nextEl: ".gallery-slider__arrow_right"
                },
                breakpoints: {
                    320: {},
                    600: {}
            ...
            if (document.querySelector(".slider-detail__slider_first")) {
                new core(".slider-detail__slider_first", {
                    modules: [ Pagination ],
                    observer: true,
                    observeParents: true,
                    slidesPerView: 1,
                    ...
                    speed: 800,
                    pagination: {
                        el: ".slider-detail__dots_first",
                        clickable: true
                    },
                    on: {}
                });
                let mainsliderImages = document.querySelectorAll(".slider-detail__image-ibg_first");
                let mainsliderDots = document.querySelectorAll(".slider-detail__dots_first .swiper-pagination-bullet");
        ...
        function documentActions(e) {
            ...
            if (window.innerWidth > 992 || isMobile.any()) {
                if (targetElement.classList.contains("menu__link")) {
                    console.log("yes");
                    targetElement.closest(".menu__item_dropdown").classList.toggle("_hover");
                }
                if (!targetElement.closest(".menu__item_dropdown") && document.querySelectorAll(".menu__item_dropdown._hover").length > 0) _removeClasses(document.querySelectorAll(".menu__item_dropdown._hover"), "_hover");
                if (targetElement.classList.contains("sub-menu__link")) {
                    console.log("yes 2");
                    targetElement.closest(".sub-menu__item_drowpdown").classList.toggle("_hover");
                }
                if (!targetElement.closest(".sub-menu__item_drowpdown") && document.querySelectorAll(".menu__item_dropdown._hover").length > 0) _removeClasses(document.querySelectorAll(".sub-menu__item_drowpdown._hover"), "_hover");
            }
        }
        document.addEventListener("keydown", (function(e) {
            if ("Escape" === e.code) {
                _removeClasses(document.querySelectorAll(".menu__item_dropdown._hover"), "_hover");
                _removeClasses(document.querySelectorAll(".sub-menu__item_drowpdown._hover"), "_hover");
            }
        }));
        let perfectCounterFirst = document.querySelector(".deals__counter");
        ...
        if (catalog) {
            let buttonGridTwoColumn = document.querySelector(".top-catalog__button_grid-two-columns");
            let buttonGridThreeColumn = document.querySelector(".top-catalog__button_grid-three-columns");
            let buttonList = document.querySelector(".top-catalog__button_list");
            let catalogItems = document.querySelector(".products-catalog__items");
            buttonGridTwoColumn.onclick = function() {
                if (buttonGridTwoColumn.classList.contains("active") && catalogItems.classList.contains("grid-two-columns")) console.log("nothing"); else {
                    buttonGridTwoColumn.classList.add("active");
                    catalogItems.classList.add("grid-two-columns");
                    buttonGridThreeColumn.classList.remove("active");
                    buttonList.classList.remove("active");
                    catalogItems.classList.remove("grid-three-columns");
                    catalogItems.classList.remove("list");
                }
            };
            buttonGridThreeColumn.onclick = function() {
                if (buttonGridThreeColumn.classList.contains("active") && catalogItems.classList.contains("grid-three-columns")) console.log("nothing"); else {
                    buttonGridThreeColumn.classList.add("active");
                    catalogItems.classList.add("grid-three-columns");
                    buttonGridTwoColumn.classList.remove("active");
                    buttonList.classList.remove("active");
                    catalogItems.classList.remove("grid-two-columns");
                    catalogItems.classList.remove("list");
                }
            };
            buttonList.onclick = function() {
                if (buttonList.classList.contains("active") && catalogItems.classList.contains("list")) console.log("nothing"); else {
